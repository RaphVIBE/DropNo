...
- **Canal :** email direct si tu trouves son adresse pro (Antwerp HQ), ou LinkedIn InMail à défaut. Ressence est petite, le standard contact@ressence.com risque de finir filtré.
- **Timing :** mardi ou mercredi matin 9-10h CET, taux d'ouverture optimal pour B2B luxe.
- **Pas de pièce jointe.** Si réponse positive, on envoie le deck en suivi du call.
- **Follow-up :** une seule relance, 8 jours après, deux phrases max.
