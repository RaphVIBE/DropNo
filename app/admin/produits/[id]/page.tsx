      ...
      <Card className="mb-4 mt-4 flex flex-wrap items-center gap-3">
        ...
        {canDelete(status) && (
          <form action={deleteDrop}>
            <input type="hidden" name="id" value={drop.id} />
            <Button type="submit" variant="outline" className="border-red-500/40 text-red-300 hover:border-red-500/60 hover:bg-red-500/10 hover:text-red-200">Supprimer</Button>
          </form>
        )}
      </Card>
